...
namespace Scalider.Security.Test
{
    ...
    public class CrcTests
    {
        ...
        public void Crc8ShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC8, value, expectedValue);
        ...
        public void Crc8Cdma2000ShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC8_CDMA2000, value, expectedValue);
        ...
        public void Crc8DarcShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC8_DARC, value, expectedValue);
        ...
        public void Crc8DvbS2ShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC8_DVB_S2, value, expectedValue);
        ...
        public void Crc8EbuShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC8_EBU, value, expectedValue);
        ...
        public void Crc8ICodeShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC8_I_CODE, value, expectedValue);
        ...
        public void Crc8ItuShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC8_ITU, value, expectedValue);
        ...
        public void Crc8MaximShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC8_MAXIM, value, expectedValue);
        ...
        public void Crc8RohcShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC8_ROHC, value, expectedValue);
        ...
        public void Crc8WcdmaShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC8_WCDMA, value, expectedValue);
        ...
        public void CrcAShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC_A, value, expectedValue);
        ...
        public void Crc16ArcShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_ARC, value, expectedValue);
        ...
        public void Crc16AugCcittShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_AUG_CCITT, value, expectedValue);
        ...
        public void Crc16BuypassShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_BUYPASS, value, expectedValue);
        ...
        public void Crc16CcittFalseShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_CCITT_FALSE, value, expectedValue);
        ...
        public void Crc16Cdma2000ShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_CDMA2000, value, expectedValue);
        ...
        public void Crc16T10DifShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_T10_DIF, value, expectedValue);
        ...
        public void Crc16Dds110ShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_DDS_110, value, expectedValue);
        ...
        public void Crc16DectRShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_DECT_R, value, expectedValue);
        ...
        public void Crc16DectXShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_DECT_X, value, expectedValue);
        ...
        public void Crc16DnpShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_DNP, value, expectedValue);
        ...
        public void Crc16En13757ShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_EN_13757, value, expectedValue);
        ...
        public void Crc16KermitShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_KERMIT, value, expectedValue);
        ...
        public void Crc16GenibusShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_GENIBUS, value, expectedValue);
        ...
        public void Crc16MaximShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_MAXIM, value, expectedValue);
        ...
        public void Crc16Mcrf4XxShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_MCRF4XX, value, expectedValue);
        ...
        public void Crc16ModbusShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_MODBUS, value, expectedValue);
        ...
        public void Crc16RielloShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_RIELLO, value, expectedValue);
        ...
        public void Crc16TelediskShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_TELEDISK, value, expectedValue);
        ...
        public void Crc16Tms37157ShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_TMS37157, value, expectedValue);
        ...
        public void Crc16UsbShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_USB, value, expectedValue);
        ...
        public void Crc16X25ShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_X_25, value, expectedValue);
        ...
        public void Crc16XmodemShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC16_XMODEM, value, expectedValue);
        ...
        public void Crc32Bzip2ShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC32_BZIP2, value, expectedValue);
        ...
        public void Crc32CShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC32_C, value, expectedValue);
        ...
        public void Crc32DShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC32_D, value, expectedValue);
        ...
        public void Crc32JamCrcShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC32_JAMCRC, value, expectedValue);
        ...
        public void Crc32Mpeg2ShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC32_MPEG2, value, expectedValue);
        ...
        public void Crc32PoxisShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC32_POXIS, value, expectedValue);
        ...
        public void Crc32QShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC32_Q, value, expectedValue);
        ...
        public void Crc32XferShouldMatchValues(string value, string expectedValue) =>
            TestAlgorithmWithMatchingValue(CrcAlgorithmNames.CRC32_XFER, value, expectedValue);
        ...
        private static void TestAlgorithmWithMatchingValue(string algorithm, string value, string expectedValue)
        {
            ...
            {
                string hashed = crc.ComputeHash(value.ToByteArray()).ToHexString();
                Assert.Equal(expectedValue, hashed);
            }
        }
    }
